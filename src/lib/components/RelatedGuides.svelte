				...
				{#each articles as a}
					...
					>
						<div class="space-y-2">
							...
							<h3 class="text-sm font-semibold text-white group-hover:text-cyan-300 transition-colors line-clamp-2 break-words">
								{a.title}
							</h3>
						...
						<div class="pt-2 flex items-center justify-between text-[11px] font-mono text-slate-400 group-hover:text-cyan-400 transition-colors border-t border-slate-800/60 min-h-[36px]">
