...
{#if facts && facts.length > 0}
	<aside
		...
		aria-label={lang === 'de' ? 'Wissenswerte Fakten und Eselsbrücken' : 'Memorable facts and mnemonics'}
	>
		<div class="flex items-center justify-between gap-2 border-b border-slate-800/80 pb-3">
			<div class="flex items-center gap-2 font-mono text-xs font-bold uppercase tracking-wider text-cyan-400">
			...
			<span class="font-mono text-[10px] uppercase px-2 py-0.5 rounded bg-cyan-950 border border-cyan-800/50 text-cyan-300">
