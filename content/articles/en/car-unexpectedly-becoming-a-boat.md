...
### The SWOC Escape Sequence

Decades of controlled immersion trials by survival physiologists established the **SWOC sequence**:

1. **S - Seatbelts**: Release seatbelts instantly.
2. **W - Windows**: Open or smash side windows immediately.
3. **O - Out (Children First)**: Push children out the window first so you can assist from behind.
4. **C - Climb Out**: Exit and swim to the surface.

Side windows are made of tempered safety glass that shatters into blunt pebbles when struck at a corner with a spring-loaded center-punch. Windshields are made of polyvinyl-laminated glass and will not open an exit path.
