...
When a headache behaves like a lightning strike, it is a medical emergency of the highest order.

### The Mechanism: Ruptured Aneurysms and Subarachnoid Hemorrhage
...
In approximately 15% to 30% of patients with aneurysmal subarachnoid hemorrhage, a catastrophic bleed is preceded days or weeks earlier by a **sentinel headache** (warning leak).

1. A tiny micro-fissure opens in the aneurysm wall, releasing a small volume of blood that rapidly clots off.
2. The patient experiences an explosive, terrifying headache that gradually subsides over 12 to 24 hours.
3. Believing they simply suffered a "bad migraine," the individual returns to normal activity.
4. Days later, the weakened aneurysm wall suffers a massive, fatal second rupture.
