...
- **Dyspnea**: Sudden shortness of breath occurring with or without significant chest discomfort.
...
- Sudden severe shortness of breath with nausea.

### Mechanical Management and Rest

When coronary arteries are obstructed, the physical workload of the heart directly dictates how fast myocardial tissue perishes. Placing the patient in a half-sitting position (approx. 45 degrees) uses gravity to pool blood in the lower extremities, lowering venous return (preload) to the right atrium and significantly decreasing myocardial wall tension. Absolute physical stillness prevents adrenaline surges that trigger fatal ventricular arrhythmias.
