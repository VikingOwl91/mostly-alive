...
subtitle: >-
  Severe acute asthma exacerbation, silent chest recognition, and rapid
...
memory_hook: >-
  Sit upright, take 4–10 puffs of rescue inhaler (1 at a time), and call 911/112
  immediately if words cannot be spoken.
memorable_facts:
  - >-
    THE SILENT CHEST PARADOX: When acute asthma narrows bronchioles completely,
    there is too little airflow to generate audible wheezing. A "silent chest"
    in an exhausted, struggling asthmatic is an ominous sign of imminent
    respiratory arrest, not improvement.
  - >-
    THE TRIPOD POSITION: Sitting upright and leaning forward with arms braced on
    the knees recruits the pectoralis major and latissimus muscles as accessory
    breathing engines, expanding thoracic volume when the diaphragm becomes
    fatigued.
immediate_action:
  - title: ADOPT TRIPOD POSITION (KUTSCHERSITZ)
    instruction: >-
      Sit upright leaning forward with hands or elbows braced against knees to
      mobilize accessory respiratory muscles.
  - title: ADMINISTER RESCUE INHALER WITH SPACER
    instruction: 'Use prescribed short-acting beta-2 agonist (Salbutamol / Albuterol):'
    substeps:
      - >-
        Inhale 4 to 10 puffs using a spacer chamber, waiting 30 to 60 seconds
        between single puffs.
      - >-
        Use pursed-lip breathing (slow exhale against lightly closed lips) to
        keep small airways open.
  - title: CALL 911 / 112 IF NO IMMEDIATE RELIEF
    instruction: >-
      Call emergency dispatch immediately if speech is fragmented, chest is
      silent, lips turn blue, or inhaler fails after 5 minutes.
do_not:
  - >-
    Do not lay the person flat on their back (horizontal positioning impairs
    diaphragm descent and accelerates respiratory failure).
  - >-
    Do not force the person into a car to drive to the hospital if an ambulance
    with advanced airway equipment and oxygen is available.
  - >-
    Do not administer cough syrup, cold medications, or sedatives (sedatives
    suppress the remaining respiratory drive and are lethal in severe asthma).
  - >-
    Do not mistake the absence of wheezing for recovery if the person is
    struggling, drowsy, or gasping (this is a silent chest).
sources:
  - name: Global Initiative for Asthma (GINA)
    ...
    jurisdiction: Global
    notes: >-
      Emergency SABA dosing protocols, spacer delivery, and silent chest
      criteria.
  - name: British Thoracic Society (BTS) / SIGN
    ...
    notes: >-
      Acute severe asthma management, 4-10 puff escalation rules, and systemic
      steroid guidelines.
